 ...
 * @LastEditTime: 2020-04-30 21:54:55
...
class VideoPlayer extends Component{
    ...
    constructor(props){
        ...
        this.videoPlayEnd = this.videoPlayEnd.bind(this)
    ...
    initSeekPanResponder() {
        this.player.seekPanResponder = PanResponder.create({
            ...
            onPanResponderMove: ( evt, gestureState ) => {
                let accumulatedDistance= gestureState.dy;
    ...
    onLoad(payload){
        this.player.ref.seek( this.props.startTime );
        this.setState({
    ...
    render(){
        ...
        let containerWidth = windowHeight
        let containerHeight = windowWidth
        videoLayout = {
            width:screenHeight,
            height:screenWidth,
            transform:[{rotate: "90deg" }],
            top:-(screenWidth - screenHeight)/2,
        ...
        return(
                ...
                style={[styles.container,videoLayout
                       ...
                       <View style={{
                           width:windowHeight,
                           height:windowWidth,
                           marginLeft:StatusBarHeight+(screenHeight - windowHeight)/2,
                           marginRight:(screenHeight - windowHeight)/2
                       }}>
                        <Video
