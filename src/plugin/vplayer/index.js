 ...
 * @LastEditTime: 2020-04-30 22:21:22
...
class VideoPlayer extends Component{
    ...
    toggleFullScreen(){
        let videoData = {...this.props,startTime:this.state.currentTime}
        console.log("in index sreen")
        console.log(videoData)
        this.props.navigation.navigate("VideoPage",{videoData:videoData})
        this.setState({
            playStatus:false
        })
    }
